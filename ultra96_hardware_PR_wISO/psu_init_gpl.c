...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SPI1_REF_CTRL_DIVISOR0                          0x6
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0080, 0x013F3F07U ,0x01010602U)
    */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_DERATEINT_MR4_READ_INTERVAL                        0x280de8

    * Temperature Derate Interval Register
    * (OFFSET, MASK, VALUE)      (0XFD070024, 0xFFFFFFFFU ,0x00280DE8U)
    */
	PSU_Mask_Write(DDRC_DERATEINT_OFFSET, 0xFFFFFFFFU, 0x00280DE8U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * ONLY.
    *  PSU_DDRC_PWRTMG_T_DPD_X4096                                 0x42
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070034, 0x00FFFF1FU ,0x00404210U)
    */
	PSU_Mask_Write(DDRC_PWRTMG_OFFSET, 0x00FFFF1FU, 0x00404210U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * d. Unit: Clocks.
    *  PSU_DDRC_RFSHTMG_T_RFC_MIN                                  0x4a

    * Refresh Timing Register
    * (OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0020804AU)
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0020804AU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT0_PRE_CKE_X1024                                0x202

    * SDRAM Initialization Register 0
    * (OFFSET, MASK, VALUE)      (0XFD0700D0, 0xC3FF0FFFU ,0x00020202U)
    */
	PSU_Mask_Write(DDRC_INIT0_OFFSET, 0xC3FF0FFFU, 0x00020202U);
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT1_DRAM_RSTN_X1024                              0x35
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700D4, 0x01FF7F0FU ,0x00350000U)
    */
	PSU_Mask_Write(DDRC_INIT1_OFFSET, 0x01FF7F0FU, 0x00350000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_DRAMTMG4_OFFSET, 0x1F0F0F1FU, 0x08040308U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_ZQCTL0_T_ZQ_LONG_NOP                               0x107
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070180, 0xF7FF03FFU ,0x81070008U)
    */
	PSU_Mask_Write(DDRC_ZQCTL0_OFFSET, 0xF7FF03FFU, 0x81070008U);
/*##################################################################### */
    ...
    * /LPDDR4 devices.
    *  PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                   0x32116

    * ZQ Control Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x00E32116U)
    */
	PSU_Mask_Write(DDRC_ZQCTL1_OFFSET, 0x3FFFFFFFU, 0x00E32116U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * cification for correct value.
    *  PSU_DDRC_DFITMG2_DFI_TPHY_WRCSLAT                           0x2

    * DFI Timing Register 2
    * (OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000502U)
    */
	PSU_Mask_Write(DDRC_DFITMG2_OFFSET, 0x00003F3FU, 0x00000502U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Refresh Period
    *  PSU_DDR_PHY_PGCR2_TREFPRD                                   0x3c20

    * PHY General Configuration Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F03C20U)
    */
	PSU_Mask_Write(DDR_PHY_PGCR2_OFFSET, 0xFFFFFFFFU, 0x00F03C20U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Power-Down Time
    *  PSU_DDR_PHY_PTR0_TPLLPD                                     0x107

    * PLL Gear Shift Time
    *  PSU_DDR_PHY_PTR0_TPLLGS                                     0x41a

    * PHY Reset Time
    *  PSU_DDR_PHY_PTR0_TPHYRST                                    0x10

    * PHY Timing Register 0
    * (OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x20E10690U)
    */
	PSU_Mask_Write(DDR_PHY_PTR0_OFFSET, 0xFFFFFFFFU, 0x20E10690U);
/*##################################################################### */
    ...
    * PLL Lock Time
    *  PSU_DDR_PHY_PTR1_TPLLLOCK                                   0x668a

    * Reserved. Returns zeroes on reads.
    *  PSU_DDR_PHY_PTR1_RESERVED_15_13                             0x0

    * PLL Reset Time
    *  PSU_DDR_PHY_PTR1_TPLLRST                                    0x93b

    * PHY Timing Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0x668A093BU)
    */
	PSU_Mask_Write(DDR_PHY_PTR1_OFFSET, 0xFFFFFFFFU, 0x668A093BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x06180F08U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x2815050AU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x2815050AU);
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DTPR2_TXS                                       0x97

    * DRAM Timing Parameters Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080118, 0xFFFFFFFFU ,0x000F0097U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR2_OFFSET, 0xFFFFFFFFU, 0x000F0097U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x00932B08U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x00932B08U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DX4GCR1_OFFSET, 0xFFFFFFFFU, 0x55556800U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * MHz.
    *  PSU_IOU_SCNTRS_BASE_FREQUENCY_ID_REGISTER_FREQ              0x5f5e102
    ...
    * terface.
    * (OFFSET, MASK, VALUE)      (0XFF260020, 0xFFFFFFFFU ,0x05F5E102U)
    */
	PSU_Mask_Write(IOU_SCNTRS_BASE_FREQUENCY_ID_REGISTER_OFFSET,
		0xFFFFFFFFU, 0x05F5E102U);
/*##################################################################### */
...
unsigned long psu_apply_master_tz(void)
{
    ...
    */
	PSU_Mask_Write(LPD_SLCR_SECURE_SLCR_RPU_OFFSET,
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(FPD_SLCR_SECURE_SLCR_SATA_OFFSET,
		0x0000000DU, 0x0000000DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SECURE_SLCR_IOU_AXI_RPRTCN_SD0_AXI_ARPROT           0

    * AXI protection [0] = '0' : Normal access [0] = '1' : Previleged access [
    * 1] = '0' : Secure access [1] = '1' : No secure access [2] = '0' : Data a
    * ccess [2] = '1'' : Instruction access
    *  PSU_IOU_SECURE_SLCR_IOU_AXI_RPRTCN_SD1_AXI_ARPROT           0

    * AXI read protection type selection
    * (OFFSET, MASK, VALUE)      (0XFF240004, 0x003F0000U ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SECURE_SLCR_IOU_AXI_RPRTCN_OFFSET,
		0x003F0000U, 0x00000000U);
/*##################################################################### */
    ...
    * 1] = '0' : Secure access [1] = '1' : No secure access [2] = '0' : Data a
    * ccess [2] = '1'' : Instruction access
    *  PSU_IOU_SECURE_SLCR_IOU_AXI_WPRTCN_SD0_AXI_AWPROT           0

    * AXI protection [0] = '0' : Normal access [0] = '1' : Previleged access [
    * 1] = '0' : Secure access [1] = '1' : No secure access [2] = '0' : Data a
    * ccess [2] = '1'' : Instruction access
    *  PSU_IOU_SECURE_SLCR_IOU_AXI_WPRTCN_SD1_AXI_AWPROT           0

    * AXI write protection type selection
    * (OFFSET, MASK, VALUE)      (0XFF240000, 0x003F0000U ,0x00000000U)
    */
...
/*Enabling REF after dqs2dq training - DTCR0.RFSHDT=8*/
	...
	Xil_Out32(0xFD070180U, 0x01070008U);
